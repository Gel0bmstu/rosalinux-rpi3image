...
def make_chroot(release, arch):
    ...
    pkgs = 'NetworkManager less systemd-units openssh-server systemd procps-ng timezone dnf sudo usbutils passwd locales-en basesystem-minimal rosa-repos-keys rosa-repos'
    print(rootfs_dir)
